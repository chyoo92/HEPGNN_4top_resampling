...
python train_4top_QCD_cla_resam.py --config config_4top_QCD_v2.yaml --epoch 200 --batch 1024 -o date202205024_resam_run1 --device 2 --cla 1 --model GNN3layer --fea 4 --lr 1e-4

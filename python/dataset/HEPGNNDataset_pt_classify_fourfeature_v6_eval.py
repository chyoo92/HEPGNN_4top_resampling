...
class HEPGNNDataset_pt_classify_fourfeature_v6_eval(PyGDataset):
    def __init__(self, **kwargs):
        super(HEPGNNDataset_pt_classify_fourfeature_v6_eval, self).__init__(None, transform=None, pre_transform=None)
        self.isLoaded = False
    ...
    def get(self, idx):
        ...
        fea_remain = self.fea_remainList[fileIdx][idx]
...
#             print(sumw, 'sumw')
            ...
            self.fea_remainList.append(remains)

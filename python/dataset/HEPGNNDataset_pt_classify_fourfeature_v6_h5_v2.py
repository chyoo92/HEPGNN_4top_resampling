...
class HEPGNNDataset_pt_classify_fourfeature_v6_h5_v2(PyGDataset):
    def __init__(self, **kwargs):
        super(HEPGNNDataset_pt_classify_fourfeature_v6_h5_v2, self).__init__(None, transform=None, pre_transform=None)
        self.isLoaded = False
...
#             nEvent = len(f)
            ...
            for j in range(nEvent):
                ...
                btag_list.append(f_fea_reshape[:,4].sum())

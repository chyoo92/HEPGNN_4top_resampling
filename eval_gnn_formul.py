...
if args.weight==0:
    ...
    df2 = pd.DataFrame({'weight':weights, 'label':labels,'real_weight':real_weights,'scale':scales,'eval_resampling':eval_resampling,'eval_real':eval_real})
    fPred2 = 'result/' + args.output + '/' + args.output + '_weight.csv'
